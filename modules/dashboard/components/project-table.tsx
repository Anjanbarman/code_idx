...
interface ProjectTableProps {
  projects: Project[];
  /** Passed from page as onUpdatedProject */
  onUpdatedProject?: (
    id: string,
...
export default function ProjectTable({
  projects,
  onUpdatedProject, // renamed to match prop used at call site
  onDeleteProject,
  onDuplicateProject,
  onMarkasFavorite,
}: ProjectTableProps) {
  ...
  const handleUpdateProject = async () => {
    if (!selectedProject || !onUpdatedProject) return;

    setIsLoading(true);
    try {
      await onUpdatedProject(selectedProject.id, editData);
      setIsLoading(false);
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                      <DropdownMenuItem asChild>
                        <MarkedToggleButton
                          // Using lowercase 'starmark' to match Prisma relation & updated Project type
                          markedForRevision={
